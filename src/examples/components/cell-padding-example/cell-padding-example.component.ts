...
@Component({
  selector: 'app-cell-padding-example',
  templateUrl: './cell-padding-example.component.html',
  styleUrl: './cell-padding-example.component.scss',
  standalone: true,
  imports: [VirtualScrollModule],
})
export class CellPaddingExampleComponent {
